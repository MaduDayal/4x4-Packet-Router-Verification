...
class possible_routes_test extends base_test;
  ...
  task possibleRoutesTest();
    ...
    wait(rEnv.rScoreBoard.num_expected == 16 && rEnv.rScoreBoard.num_actual == 16 && rEnv.packCov.num_sampled == 16);
